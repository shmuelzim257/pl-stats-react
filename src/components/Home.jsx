  ...
  return (
    <div className="container">
      ...
      <section className="home-section">
        ...
        <p>
          מעבר לצד המקצועי, אחד התחביבים שלי הוא שילוב של סטטיסטיקה וספורט – במיוחד פרמייר ליג ופנטזי.
          ...
          מנג&apos;ר, ובין אם זה בהבנה של משחקים בעת צפייה בהם.
        </p>
        <p>
          האתר הזה מחבר בין שני העולמות: מצד אחד הקריירה שלי כמנהל פרויקטים
          בעולם AI ו-Cloud, ומצד שני האהבה לנתונים, כדורגל וחשיבה אנליטית. באתר זה 
